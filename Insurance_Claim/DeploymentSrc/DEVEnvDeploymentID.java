...
public class DEVEnvDeploymentID{
...
Document doc = docBuilder.parse (new File("DEVEnvDeploymentID.xml"));
...
PrintWriter writer = new PrintWriter("DEVEnvDeploymentID.txt", "UTF-8");
