...
public class PRODEnvDeploymentID{
...
Document doc = docBuilder.parse (new File("PRODEnvDeploymentID.xml"));
...
PrintWriter writer = new PrintWriter("PRODEnvDeploymentID.txt", "UTF-8");
